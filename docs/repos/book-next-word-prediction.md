# book-next-word-prediction

PhD-level Springer textbook: Predicting the Next Word - A Mathematical Foundation of Language Models

[View on GitHub](https://github.com/Digital-AI-Finance/book-next-word-prediction){ .md-button .md-button--primary }
