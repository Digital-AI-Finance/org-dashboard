...
[View on GitHub](https://github.com/Digital-AI-Finance/Systematic-Literature-Reviews-with-Artificial-Intelligence){ .md-button .md-button--primary }
...
| [data](https://github.com/Digital-AI-Finance/Systematic-Literature-Reviews-with-Artificial-Intelligence/blob/main/data) |  | 0.0 KB |

| [benchmarks.json](https://github.com/Digital-AI-Finance/Systematic-Literature-Reviews-with-Artificial-Intelligence/blob/main/data/benchmarks.json) | .json | 1.43 KB |

| [papers.json](https://github.com/Digital-AI-Finance/Systematic-Literature-Reviews-with-Artificial-Intelligence/blob/main/data/papers.json) | .json | 2.78 KB |

| [tools.json](https://github.com/Digital-AI-Finance/Systematic-Literature-Reviews-with-Artificial-Intelligence/blob/main/data/tools.json) | .json | 2.47 KB |
