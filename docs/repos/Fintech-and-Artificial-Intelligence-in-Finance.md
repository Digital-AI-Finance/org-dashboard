...
| [deliverables_inventory.json](https://github.com/Digital-AI-Finance/Fintech-and-Artificial-Intelligence-in-Finance/blob/main/deliverables_inventory.json) | .json | 106.92 KB |

| [publication_catalog.json](https://github.com/Digital-AI-Finance/Fintech-and-Artificial-Intelligence-in-Finance/blob/main/docs/publication_catalog.json) | .json | 76.79 KB |
...
| [CIG_FILE_INVENTORY.json](https://github.com/Digital-AI-Finance/Fintech-and-Artificial-Intelligence-in-Finance/blob/main/downloads/docs/CIG_FILE_INVENTORY.json) | .json | 67.96 KB |
...
| [members_extract.json](https://github.com/Digital-AI-Finance/Fintech-and-Artificial-Intelligence-in-Finance/blob/main/members_extract.json) | .json | 1.4 KB |
