...
def generate_reproducibility_report(repos_data: List[Dict]) -> Dict:
    ...
    print(f"Reproducibility report saved to data/reproducibility_report.json")
    return report
...
def main():
    ...
    if os.path.exists('data/repos.json'):
        ...
        print(f"   Average org score: {report['organization_summary']['average_reproducibility_score']}")
