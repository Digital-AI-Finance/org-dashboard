...
class CodeQualityAnalyzer:
    ...
    def calculate_quality_score(self, metrics: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'complexity_ratio': round(complexity_ratio * 100, 2) if metrics['lines_of_code'] > 0 else 0
        }
...
def analyze_all_repositories(repos_data: List[Dict]) -> Dict[str, Any]:
    ...
    avg_structure_score = sum(
        ...
        for r in quality_report['repositories'].values()
    ) / len(repos_data) if repos_data else 0
