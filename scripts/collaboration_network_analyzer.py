...
class CollaborationNetworkAnalyzer:
    ...
    def build_collaboration_network(self, repos_data: List[Dict[str, Any]],
        ...
        for repo in repos_data:
            ...
            for author in authors:
                ...
                if (author_stats[author_login]['first_commit'] is None or
                    commit_date < author_stats[author_login]['first_commit']):
                    author_stats[author_login]['first_commit'] = commit_date

                if (author_stats[author_login]['last_commit'] is None or
                    commit_date > author_stats[author_login]['last_commit']):
    ...
    def calculate_network_metrics(self, network: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'top_central_authors': [
                {'author': author, 'centrality': float(cent)}
                for author, cent in top_central
            ],
            'top_collaborations': [
    ...
    def create_network_visualization(self, network_data: Dict[str, Any],
                                     output_dir: str) -> str:
    ...
    def create_author_metrics_chart(self, network_data: Dict[str, Any],
                                    output_dir: str) -> str:
...
def analyze_collaboration_network(repos_data: List[Dict], org_name: str,
    ...
    if os.path.exists('data/repos.json'):
        ...
        if 'error' not in results:
            ...
            for collab in results['metrics']['top_collaborations'][:5]:
                print(f"  {collab['author1']} ↔ {collab['author2']}: {collab['shared_repos']} shared repos")
