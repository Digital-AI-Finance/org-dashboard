...
class RepositoryHealthScorer:
    ...
    def calculate_code_quality_score(self, repo: Dict[str, Any], quality_report: Dict = None) -> Dict[str, Any]:
        ...
        if quality_report and repo['name'] in quality_report.get('repositories', {}):
            ...
            return {
                ...
                'details': repo_quality.get('structure', {})
            }
    ...
    def calculate_overall_health(self, repo: Dict[str, Any], quality_report: Dict = None) -> Dict[str, Any]:
        ...
        overall_score = sum(
            scores[dimension]['score'] * self.weights[dimension]
...
def generate_health_report(repos_data: List[Dict], quality_report: Dict = None) -> Dict[str, Any]:
    ...
    # Overall average
    all_overall_scores = [
        r['overall_score'] for r in health_report['repositories'].values()
    ]
